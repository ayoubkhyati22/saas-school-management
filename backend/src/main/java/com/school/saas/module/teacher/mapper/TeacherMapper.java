...
public class TeacherMapper {
    ...
    public TeacherDTO toDTO(Teacher teacher) {
        ...
        return TeacherDTO.builder()
                ...
                .specialityId(teacher.getSpeciality() != null ? teacher.getSpeciality().getId() : null)
                .specialityName(teacher.getSpeciality() != null ? teacher.getSpeciality().getName() : null)
                .specialityCode(teacher.getSpeciality() != null ? teacher.getSpeciality().getCode() : null)
