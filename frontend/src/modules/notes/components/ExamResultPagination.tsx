...
interface ExamResultPaginationProps {
  currentPage: number
  totalPages: number
  totalItems: number
  pageSize: number
...
export default function ExamResultPagination({ currentPage, totalPages, totalItems, pageSize, onPageChange }: ExamResultPaginationProps) {
